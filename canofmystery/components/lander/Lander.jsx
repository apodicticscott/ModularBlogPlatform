    ...
    return (
        <div className="h-max  w-screen 3xl:h-[60vw] 3xl:max-h-screen overflow-hidden flex flex-col lg:flex-row bg-base-100 ">
            <div className="h-full w-[100%] mt-16 pt-[10px] lg:mt-0 lg:w-full flex flex-col justify-between lg:flex-row lg:items-center bg-primary dark:bg-secondary-dark lg:border-b-3 lg:border-b-0 lg:border-r-black lg:border-r-3"  >
                <div className="3xl:flex 3xl:flex-col 3xl:w-[60vw] w-full h-[350px] lg:h-max px-7  lg:px-0 py-[20px] lg:py-0 3xl:items-start 3xl:pr-[50px]">
                ...
                <div className="xs:h-[500px] xs-sm:h-[450px] lg:w-[925px]  lg:hidden px-7  lg:pt-28 flex flex-col justify-end dark:bg-base-100-dark text-t-header-light bg-base-100 dark:text-t-dark border-y-2 border-b-black"> 

                    <Header type="md" classes={"relative top-[-25px]"}>
                            Ghosts And Ghouls
                    </Header>
                    <div className="relative top-[-15px] md:top-[-25px] max-w-full min-h-[400px] xs-sm:min-h-[400px]  md:min-h-[400px] bg-dark-purple rounded-lg border-2 my-[10px] shadow-lg">
