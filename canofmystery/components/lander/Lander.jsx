...
const Lander = () => {
    ...
    return (
        <div className="h-max  w-screen overflow-hidden flex flex-col lg:flex-row bg-base-100 ">
            <div className="h-full w-[100%] mt-16 pt-[10px] lg:mt-0 lg:w-full flex flex-col justify-between lg:flex-row lg:items-center bg-primary dark:bg-secondary-dark border-b-3 dark:border-b-[#302c38] dark:border-b-[1px] lg:border-r-black lg:border-r-3"  >
                ...
                <div className="xs:h-[450px] xs-sm:h-[450px] lg:w-[925px]  lg:hidden px-7  lg:pt-28 flex flex-col justify-end dark:bg-base-100-dark text-t-header-light bg-base-100 dark:text-t-dark border-y-2 border-b-black"> 
                    ...
                    <div className={`${!article.image && "skeleton-lander"} relative top-[-15px] md:top-[-25px] min-w-full xs:min-h-[400px] xs-sm:min-h-[400px]  md:min-h-[400px] bg-dark-purple rounded-lg border-2 my-[10px] shadow-lg`}>
                        {
                            article.image 
                            &&
                ...
                <div className="h-full w-[784px] 3xl:w-[60vw] 3xl:px-[2.5vw] hidden lg:flex px-14 pt-28 flex flex-col border-l-3 border-l-black dark:border-l-[#302c38] dark:border-l-[1px] justify-center dark:bg-base-100-dark text-t-header-light bg-base-100 dark:text-t-dark"> 
                    <Header type="md" styles="pb-[20px]">
                        { article.title ? article.title : <div className="skeleton h-max w-max"><span className="opacity-0">Example Title Here</span></div> }
                    </ Header >
                    <div className={`${!article.image && "skeleton-lander"} h-[35vw] w-[45vw] lg:h-[450px] lg:w-[650px] 3xl:w-full 3xl:h-[28vw] 3xl:my-[2vw] bg-dark-purple rounded-lg border-3 dark:border-[#302c38] dark:border-[1px] dark:shadow-none my-[26px] shadow-lg`}>
                        {
                            article.image 
                            &&
                            <img src={article.image} alt="Uploaded Image" className="w-full object-cover h-full bg-dark-purple rounded-[15px] border-3 dark:border-[#302c38] dark:border-[1px]"/>
                        }
