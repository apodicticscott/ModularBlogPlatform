            ...
            <div className="h-full w-[100%] mt-16 pt-[10px] lg:mt-0 lg:w-full flex flex-col justify-between lg:flex-row lg:items-center bg-primary dark:bg-secondary-dark lg:border-b-3 lg:border-b-0 lg:border-r-black lg:border-r-3"  >
                <div className="3xl:flex 3xl:flex-col 3xl:w-[60vw] w-full h-max px-7  lg:px-0 py-[20px] lg:py-0 3xl:items-start 3xl:pr-[50px]">
                    <div className="w-full 3xl:w-[45vw] lg:pl-7 3xl:px-[2.5vw] lg:min-h-[230px]">
                        <Header type="landerTitle" classes="flex flex-col gap-0 sm:flex-row md:flex-row lg:flex-col xl:flex-row lg:w-[100%] xl:w-[90%]">
                ...
                <div className="h-[90vw] xs-sm:h-[60vw] sm:h-[50%] lg:w-[925px]  lg:hidden px-7  lg:pt-28 flex flex-col justify-end dark:bg-base-100-dark text-t-header-light bg-base-100 dark:text-t-dark border-y-2 border-b-black"> 

                    <Header type="md" classes={"relative top-[-25px]"}>
                            Ghosts And Ghouls
                    </Header>
                    <div className="relative top-[-15px] md:top-[-25px] max-w-full min-h-[80vw] xs-sm:min-h-[65vw]  md:min-h-[45vh] bg-dark-purple rounded-lg border-2 my-[10px] shadow-lg">
